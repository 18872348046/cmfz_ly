...
<div style="text-align: center;" class="zi">
    <form action="" method="post" enctype="multipart/form-data" id="lawssave" class="easyui-form">
        ...
        <div style="margin-top: 20px;">
            作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;者：<input  id="gurns" name="gurn_id" data-options="required:true,width:200,height:30" /></br>
        </div>
        <div style="margin-top: 20px;">
