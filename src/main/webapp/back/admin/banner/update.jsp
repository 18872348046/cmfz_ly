...
<script>
    $(function(){
        $("#bannerUpdate").form('load','${pageContext.request.contextPath}/banner/findById?id=${param.id}')
    });
</script>
<style>
    .zi{
...
<div style="text-align: center;" class="zi">
    <form action="" method="post" enctype="multipart/form-data" id="bannerUpdate" class="easyui-form">
        <input type="hidden" name="id"></br>
        <div style="margin-top: 20px;">
            标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：<input type="text"  name="title" class="easyui-textbox" data-options="required:true,width:200,height:30"></br>
        </div>
        <div style="margin-top: 20px;">
            图&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;片：<input type="text" name="img" value="${param.img}" class="easyui-filebox" data-options="required:true,width:200,height:30"></br>
        </div>
        <div style="margin-top: 20px;">
